      ...
      <Box sx={{ minHeight: "100vh", bgcolor: "background.default", display: "flex", alignItems: "center" }}>
        <Container maxWidth="sm">
          ...
          >
            ...
            <Typography variant="body1" sx={{ color: "text.secondary", lineHeight: 1.6 }}>
              No hay cursos activos disponibles para añadir una evaluación. Por favor, añade un curso primero.
            </Typography>
          </Paper>
        </Container>
      </Box>
    ...
    <Box sx={{ minHeight: "100vh", bgcolor: "background.default", py: 4 }}>
      <Container maxWidth="sm">
        <Stack spacing={4}>
          ...
          >
            <Box sx={{ p: 4 }}>
              <AddEvaluationForm courses={courses || []} coursesError={coursesError} onSuccess={handleFormSuccess} />
            </Box>
          </Paper>
        </Stack>
      </Container>
